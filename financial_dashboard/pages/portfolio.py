        ...
        rx.vstack(
            ...
            rx.box(
                ...
                rx.recharts.scatter_chart(
                    ...
                    rx.recharts.x_axis(data_key="risk", name="Risk (%)", type_="number", tick={"fill": _FAINT, "fontSize": 11}, label={"value": "Annualised Risk (%)", "position": "insideBottom", "offset": -5, "fill": _FAINT, "fontSize": 12}),
                    rx.recharts.y_axis(data_key="return", name="Return (%)", type_="number", tick={"fill": _FAINT, "fontSize": 11}, label={"value": "Annualised Return (%)", "angle": -90, "position": "insideLeft", "offset": 10, "fill": _FAINT, "fontSize": 12}),
                    width="100%",
                    height=350,
