...
- [x] 01-02-PLAN.md — Refresh Prices button UI with streaming feedback
- [x] 01-03-PLAN.md — Gap closure: seed 7 demo company price files
...
Plans:
- [x] 04-01-PLAN.md — TDD: test scaffold + portfolio_optimization.py pure math module
